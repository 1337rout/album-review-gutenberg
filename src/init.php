 ...
 * @since 1.0.0
 */
function album_review_cgb_block_assets() { // phpcs:ignore
	...
	wp_localize_script(
		...
		[
			...
			'lastFmApiKey' => get_option( 'album_review_settings_option_name' )['last_fm_api_key_0'],
...
function render_album_review($attributes){
	...
	<div class="album-review">
		<div class="album-cover-cont">
			<img src="<?php echo $attributes['albumCoverArtUri']?>">
		</div>
		<div class="album-details">
			<h3 class="album-name-author"><strong><?php echo $attributes['albumTitle']; ?></strong>
